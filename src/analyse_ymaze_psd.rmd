...
combined_g = plot_grid(g1, g2, labels = c("A", "B"), ncol = 2, rel_widths = c(1.6,2), label_size = 26)
#ggsave(file=paste0(img_dir, '/', 'ymaze_slow&med_gamma.svg'), plot=combined_g, width=12, height=7)
...
gA = plot.mpsd('~/Dropbox/cam/ach/report/data/albert_mpsd.csv')
gN = plot.mpsd('~/Dropbox/cam/ach/report/data/nigel_mpsd.csv')
combined_g = plot_grid(gA, gN, labels = c("Stimulated", "Control"))
combined_g
